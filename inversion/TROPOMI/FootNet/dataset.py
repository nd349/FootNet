...
class FootDataset(Dataset):
    ...
    def transform_func_24h(self, _xx, _6xx, _12xx, _18xx, _24xx, comb_plume, gp_first):
        '''
        xx: (400, 400, 14)
        yy: (400, 400)
        ...
        return np.concatenate([gp_first, _xx, _6xx, _12xx, _18xx, _24xx, comb_plume], axis=-1)
    ...
    def __getitem__(self, idx):
        ...
        tempx = self.transform_func_24h(_pred.copy(), _6hpred.copy(), _12hpred.copy(), _18hpred.copy(), _24hpred.copy(), combined_gp.copy(), gp_first.copy())
