...
class FootNet():
    def __init__(self, model, device, n_channels, n_classes, emulator_model_path, epsilon):
        ...
        self.model = model(n_channels=n_channels, n_classes=n_classes).to(self.device)
