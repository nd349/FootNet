...
#simName <- 'savio'
#simName <- 'lowprio'
#simName <- 'lowprioSAVIO'
# simName <- 'foot'
# Serial
simName <- 'serial'
n_nodes <- 1
n_cores <- 1
# savio2 (savio2_bigmem)
if (simName == 'hermes') {
   n_cores <- 32
   n_nodes <- 7
   slurm_options <- list(
...
## Trim to 03/2019 and 04/2019
tID <- as.POSIXct('2013-10-19 05:00:00', tz = 'UTC') <= run_times & run_times < as.POSIXct('2013-10-19 06:00:00', tz = 'UTC')
