...
# @Last Modified time: 2025-06-23 22:12:05
...
files = get_files(f"/home/disk/hermes/nd349/data/inversion/posterior/BEACON/FootNet_off_diag_Sa_xy/NestedUNet24h_fullrun/{mode}/", extension=".ncdf")
...
nodelist = ['h2', 'h3', 'h4', 'h5', 'h6', 'h7', 'h8', 'h9', 'h10', 'h12', 'h14', 'h15', 'h16', 'h17', 'h24']
...
def create_submission_bash(date, term, node=''):
    ...
    with open('job.sh', 'w') as file:
        ...
        if emulator:
            file.writelines(f"#SBATCH -o /home/disk/hermes/nd349/data/inversion/runs/logs/FootNet_off_diag_Sa_xy/NestedUNet24h_fullrun/{mode}/{date}.out  # send stdout to outfile\n")
        else:
